# Generated by Django 5.2.6 on 2025-10-05 05:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, help_text='Указывает, следует ли считать этого пользователя активным. Снимите этот флажок вместо удаления учётных записей.', verbose_name='active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filename', models.CharField(blank=True, max_length=100, verbose_name='Имя файла')),
